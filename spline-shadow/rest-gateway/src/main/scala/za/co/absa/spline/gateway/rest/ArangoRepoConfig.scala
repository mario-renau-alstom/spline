...
import org.apache.commons.configuration.{AbstractConfiguration, CompositeConfiguration, EnvironmentConfiguration, SystemConfiguration}
...
object ArangoRepoConfig
  extends CompositeConfiguration(asList(new SystemConfiguration, new EnvironmentConfiguration))
